...
- (NSMutableAttributedString *)getAttachmentTextWithStr:(NSString *)labelText image:(id)data
{
    ...
    NSMutableAttributedString *attachText = [NSMutableAttributedString attachmentStringWithContent:image contentMode:UIViewContentModeCenter attachmentSize:image.size alignToFont:self.textFont alignment:YYTextVerticalAlignmentCenter];
