...
//    NSLog(@"%@", _belowBtnDataArr);
    
    UIButton *compileBtn = [[UIButton alloc]init];
    [compileBtn setTitleColor:ColorHex(@"f8b643") forState:UIControlStateNormal];
...
//    [compileBtn setTitle:@"完成" forState:UIControlStateSelected];
    ...
    [channelLabel addSubview:tipLabel];
...
//    btn.selected = !btn.selected;
    ...
    if (_delegate && [_delegate respondsToSelector:@selector(completionBtnClicked:)]) {
        [_delegate completionBtnClicked:btn];
    }
}
