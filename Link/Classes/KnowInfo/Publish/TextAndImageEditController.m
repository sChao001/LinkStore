...
@interface TextAndImageEditController () <UITextViewDelegate,NSTextStorageDelegate,UIScrollViewDelegate,UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
@implementation TextAndImageEditController
...
-(void)setRightBarButtonItem{
    ...
    [rightButton setTitle:@"添加图片" forState:UIControlStateNormal];
...
- (UIScrollView *)textScroller{
    if (!_textScroller) {
        _textScroller = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, ScreenW, ScreenH)];
