...
- (UIButton *)deleButton{
    ...
    if (!_deleButton) {
        ...
        [_deleButton setImage:[UIImage imageNamed:@"叉号2"] forState:UIControlStateNormal];
...
- (UIButton *)phtoDeleButton{
    ...
    if (!_phtoDeleButton) {
        ...
        [_phtoDeleButton setImage:[UIImage imageNamed:@"叉号2"]forState:UIControlStateNormal];
