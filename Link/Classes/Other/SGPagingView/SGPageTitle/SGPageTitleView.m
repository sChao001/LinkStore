...
- (instancetype)initWithFrame:(CGRect)frame delegate:(id<SGPageTitleViewDelegate>)delegate titleNames:(NSArray *)titleNames {
    self.titleFont = [UIFont systemFontOfSize:kWidthScale(13)];
...
- (void)internalMethod_changeSelectedButton:(UIButton *)button {
    ...
    if (self.tempBtn == nil) {
        button.selected = YES;
        self.tempBtn = button;
//        [self.tempBtn setBackgroundImage:[UIImage imageWithColor:RGB(2, 133, 193)] forState:UIControlStateSelected];
        [self.tempBtn setBackgroundImage:[UIImage imageWithColor:_selectedBtnColor] forState:UIControlStateSelected];
