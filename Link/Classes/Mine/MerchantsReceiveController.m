...
@interface MerchantsReceiveController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation MerchantsReceiveController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([model.statusValue isEqualToString:@"已提现"]) {
        cell.isToMoney.text = model.statusValue;
        cell.isToMoney.textColor = ColorHex(@"00e800");
    }
