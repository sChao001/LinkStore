...
@interface JoinPartnerViewController () <WKNavigationDelegate>
...
- (void)configWebViewLayout {
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@s/cooperation/cooperation?sign=%@&userId=%@", MAIN_URL, BD_MD5Sign.md5String, [UserInfo sharedInstance].getUserid];
    NSLog(@"%@", urlStr);
