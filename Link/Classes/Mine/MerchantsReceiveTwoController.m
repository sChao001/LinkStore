//
//  MerchantsReceiveTwoController.m
//  Link
//
//  Created by Surdot on 2018/8/30.
...
@interface MerchantsReceiveTwoController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation MerchantsReceiveTwoController
...
- (void)leftBarItemBack {
    if ([UserDefault boolForKey:@"isReceiveMoney"]) {
