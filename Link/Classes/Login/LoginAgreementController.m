//
//  LoginAgreementController.m
//  Link
//
//  Created by Surdot on 2018/8/21.
...
@interface LoginAgreementController () <WKNavigationDelegate>
@property (nonatomic, strong) WKWebView *webView;

@end

@implementation LoginAgreementController
